...
import { addProduct, CartItem, minusProduct, removeProduct } from "../redux/slices/cartSlice"
...
const CartProduct: React.FC<CartProductProps> = ({ id, title, type, price, count, imageUrl, size }) => {
